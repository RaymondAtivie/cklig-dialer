          ...
          <div class="col-12">
            <div class="container">
              <div class="footer">
                <p>
                  ?בסביבה חדשים
                  <span style="font-weight:400;">www.phoneplus.co.il</span>
                </p>
                ...
                <div class="col-9">
                  <div v-if="currentView === 'login-view'">
                    ...
                    <div class="row align-items-center">
                      ...
                      <div class="col text-left">
                        <span
                          class="form-bottom-text"
                          @click="handleViews('forgot-password-view')"
                        >כחתי את הסיסמה ש</span>
                      </div>
                    </div>
                    <div class="form-error text-right px-3 mt-2">
                      <p>
                        <span class="font-weight-bold">הודעת שגיאה!</span> משהו לא תקין, הטקסט מגיע מדאטבייס.
                      </p>
                    ...
                    <div class="row justify-content-center mt-4">
                      <div class="col-10">
                        <ck-button
                          @click="handleViews('signup-view')"
                          class="px-5 border-0"
                          customBg="#f26f3b"
                        >כניסה למערכת</ck-button>
                      </div>
                    </div>
                  </div>
                  <div v-if="currentView === 'signup-view'">
                    ...
                    <div class="row justify-content-center mt-5">
                      <div class="col-10">
                        <span class="ml-3 back-navigation" @click="back">חזור ובטל</span>
                        <ck-button
                          @click="handleViews('signup-view-two')"
                          class="px-5 border-0"
                          customBg="#f26f3b"
                        >הרשמה למערכת</ck-button>
                      </div>
                    </div>
                  </div>
                  <div v-if="currentView === 'signup-view-two'">
                    ...
                    <div class="row justify-content-center mt-5">
                      <div class="col-10">
                        <span class="ml-3 back-navigation" @click="back">חזור ובטל</span>
                        <ck-button
                          @click="handleViews('signup-payment-view')"
                          class="px-5 border-0"
                          customBg="#f26f3b"
                        >המשך הרשמה</ck-button>
                      </div>
                    </div>
                  </div>
                  <div v-if="currentView === 'signup-payment-view'">
                    <div class="row">
                      ...
                      <div class="col-4">
                        <ck-card-select
                          @selected="handlePaymentOptions('card')"
                          :active="selectedPaymentOption == 'card'"
                          icon="credit-card"
                          title="כ.אשראי"
                        />
                      </div>
                      <div class="col-4">
                        <ck-card-select
                          @selected="handlePaymentOptions('paypal')"
                          :active="selectedPaymentOption == 'paypal'"
                          icon="paypal"
                          title="פיי-פל PayPal"
                        />
                      </div>
                      <div class="col-4">
                        <ck-card-select
                          @selected="handlePaymentOptions('cash')"
                          :active="selectedPaymentOption == 'cash'"
                          icon="cash"
                          title="העברה בנקאית"
                        />
                      </div>
                    ...
                    <div class="form-success text-right px-3 mt-2">
                      <p>
                        <span class="font-weight-bold">הודעת הצלחה!</span> התשלום בכרטיס אשראי הוגדר בהצלחה
                      </p>
                    ...
                    <div class="row justify-content-center mt-5">
                      <div class="col-10">
                        ...
                        <ck-button
                          ...
                          :disabled="selectedPaymentOption.length > 1 ? false : true"
                          class="px-5 border-0"
                          customBg="#f26f3b"
                        >המשך הרשמה</ck-button>
                      </div>
                  ...
                  <div v-if="currentView === 'forgot-password-view'">
                    ...
                    <div class="row justify-content-center mt-5">
                      <div class="col-10">
                        <span class="ml-3 back-navigation" @click="back">חזור ובטל</span>
                        <ck-button class="px-5 border-0" customBg="#f26f3b">איפוס סיסמה</ck-button>
                      </div>
                    </div>
                  </div>
                </div>
